# Generated by Django 6.0.5 on 2026-05-14 22:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('comprador', 'Comprador'), ('vendedor', 'Vendedor'), ('admin', 'Administrador')], default='comprador', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.CharField(choices=[('high', 'Disponible'), ('low', 'Poco stock'), ('out', 'Agotado')], default='high', max_length=10)),
